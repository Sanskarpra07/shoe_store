...
<div class="stat-grid">
    <div class="stat-card">
        ...
        <div>
            <div class="stat-value">NPR <?= number_format($range_revenue, 2) ?></div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div class="stat-value">NPR <?= number_format($range_pending_pay, 2) ?></div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div class="stat-value">NPR <?= number_format($avg_order_value, 2) ?></div>
...
<div class="panel-card" style="max-width:520px;">
    ...
    <tr>
        ...
        <td class="center">NPR <?= number_format($p['rev'], 2) ?></td>
    </tr>
    <?php endwhile; ?>
    </table>
    </div>
...
<div class="panel-card" style="max-width:620px;">
    ...
    <tr>
        ...
        <td class="center">NPR <?= number_format($r['revenue'], 2) ?></td>
    </tr>
    <?php endwhile; ?>
